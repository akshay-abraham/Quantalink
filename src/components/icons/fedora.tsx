/**
 * @file src/components/icons/fedora.tsx
 * @description The official logo for Fedora as an SVG component.
 */
export const FedoraIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    role="img"
    viewBox="0 0 24 24"
