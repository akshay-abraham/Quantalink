...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    content:
      "This isn't just a static image. It's a real-time particle simulation inspired by quantum physics, running right in your browser.",
  ...
  },
  {
    ...
    content:
      "The centerpiece of this portfolio is a game inspired by Schrödinger's Cat. Want to try it?",
    action: {
      type: 'scroll_to',
      label: 'Yes, show me!',
  ...
  },
  {
    ...
    content:
      "The tech behind this site is just as interesting! When you're ready, let's explore the skills that made it possible.",
    action: {
      type: 'scroll_to',
  ...
  },
  {
    ...
    content:
      "That's the grand tour! Feel free to explore the rest of the site at your own pace.",
  ...
  },
  {
    ...
    content:
      "If you have any ideas for improvement or find any bugs, I'd love to hear from you.",
    autoAdvanceAfter: 3000,
  },
  {
    id: 'outro-final',
    ...
    content: (
      <>
        <p className="mb-4 text-sm">
          The code for this entire project is open-source. For details or to
          contribute, please visit the repository.
        </p>
        <a
          href="https://github.com/akshay-abraham/Quantalink"
          target="_blank"
