...
export const specialEvents: SpecialEvent[] = [
  ...
  createFriendBirthday(
    'William',
    '10-31',
    'Hope you have a spooky and spectacular day!'
  ),
  createFriendBirthday(
    'Steve',
    '09-05',
    'Happy birthday to a great friend! Have a fantastic day.'
  ),
  createFriendBirthday(
    'Snitha Ann Shinu',
    '09-11',
  ...
  },
  {
    ...
    date: '08-15',
    message:
      'Remembering our past and celebrating a future of progress. Jai Hind!',
    icon: <Flag className="h-10 w-10" />,
    particleType: 'popper',
    eventType: 'holiday',
  },
  {
    ...
    message:
      'May the colors and joy of Onam fill your home with happiness and prosperity.',
