...
export const metadata: Metadata = {
  ...
  description:
    'Learn more about Akshay K Rooben Abraham, a student with a passion for physics, electronics, and open-source technology.',
...
const aboutSections = [
  {
    ...
    title: 'My Studies',
    content:
      "I'm currently a high school student focusing on Physics, Chemistry, Math, and Biology (PCMB). I find the fundamental principles of science deeply fascinating and enjoy the process of learning how the world works.",
  },
  {
    icon: <Telescope className="h-8 w-8" />,
    title: 'Curiosity & Hobbies',
    content:
      "Outside of my core subjects, I have a strong interest in electronics and how software and hardware can work together. For the past few years, I've enjoyed tinkering with Arduino and ESP boards, and I'm always trying to learn more about C, Python, and using tools like Git.",
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: 'Collaboration',
    content:
      "I believe that working with others is one of the best ways to learn. In school, I've had opportunities to participate in group activities and student bodies, which has been a valuable experience in teamwork and responsibility.",
  },
];
